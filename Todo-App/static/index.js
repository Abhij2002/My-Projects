...
// function updateTaskList(tasks) {
    ...
    tasks.forEach(task => {
        ...
        listItem.style.background="linear-gradient(-45deg,#571845,#25040d)"
        listItem.style.color="azure";
        taskList.style.fontSize="2rem";
        listItem.style.paddingLeft="1rem";
        listItem.style.paddingTop="0.5rem";
        listItem.style.paddingBottom="0.5rem";
        listItem.style.marginRight="1.8rem";
        listItem.style.borderRadius="1rem";
        listItem.style.display="flex";
        listItem.style.flexDirection="row";
        // const ul= document.createElement("ul");
        // ul.style.marginTop="-7rem";
        // ul.style.marginLeft="25rem";
